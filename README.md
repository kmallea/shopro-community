...
- [Get started with ShoPro](docs/getting-started.md)
...
1. **Plan** — Build a timed rundown with segments, notes, scripts, and production details.
2. **Rehearse** — Test timing and transitions without changing the real show.
3. **Run** — Track the current segment, upcoming content, and timing variance in real time.
4. **Collaborate** — Give producers, hosts, guests, and observers the right live view.
5. **Present** — Drive tickers, chyrons, rundowns, and themed graphics in OBS.
6. **Review** — Save highlights and turn segment timing into chapters or an editing log.
...
- Small teams that need role-specific, synchronized show views
...
Please read our [contribution guide](CONTRIBUTING.md) and [Code of Conduct](CODE_OF_CONDUCT.md) before participating. For account or usage help, see [Support](SUPPORT.md). Do not report security vulnerabilities in public issues; follow the private process in [SECURITY.md](SECURITY.md).

## Links

- [Open ShoPro](https://shopro.live)
